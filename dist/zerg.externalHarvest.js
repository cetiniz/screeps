  ...
  run: function(creep, currentRoom) {
    ...
    if(creep.memory.upgrading){
      ...
      if(creep.memory.right){
        ...
        console.log
        if(creep.harvest(Game.flags['source1'].pos.lookFor(LOOK_SOURCES)[0]) == ERR_NOT_IN_RANGE){
          creep.moveTo(Game.flags['source1'].pos.lookFor(LOOK_SOURCES)[0]);
        }
      }
    }
  }
...
module.exports = externalHarvest;
